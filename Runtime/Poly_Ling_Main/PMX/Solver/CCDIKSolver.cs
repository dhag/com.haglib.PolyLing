...
//
//   【残差を測る手順】
//   VMDApplier の TraceEnabled と TraceDirectory を立てると
//   vmd_summary.csv（frame,ikBone,iterUsed,distStart,distEnd,distBest,…）が出る。
//   VMD → VRMA パネルの「IK トレース出力先」がその口。
//   iterUsed は最良だった反復番号で、-1 は一度も改善しなかったことを指す
//   （＝最初から収束済み）。0 は 1 回目が最良でそれ以降動かなかったこと。
// ================================================================
