...
namespace Poly_Ling.CSV
{
    ...
    public static class PmxBoneCSVParser
    {
        ...
        private static readonly Poly_Ling.CSV.PmxBoneCSVSchema _schema = new Poly_Ling.CSV.PmxBoneCSVSchema();
        ...
        public static List<PmxBoneData> Parse(string content)
        {
            ...
            foreach (var row in rows)
            {
                ...
                if (rowType == Poly_Ling.CSV.PmxBoneCSVSchema.RowTypeValue)
                {
