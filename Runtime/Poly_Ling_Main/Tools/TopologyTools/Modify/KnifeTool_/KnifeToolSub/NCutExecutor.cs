...
namespace Poly_Ling.Tools
{
    public static class NCutExecutor
    {
        ...
        // 【透視補正を入れてはならない】
        // ここに渡る t は i/divisions、つまり N 等分の幾何比率であり、
        // スクリーン空間由来ではない。SimpleCutExecutor.ScreenUToGeomT を
        // 適用すると等分割が崩れる。スクリーン上のクリック位置から比率を
        // 求めている箇所（KnifeTool.ComputeClickRatio）とは性質が違う。
