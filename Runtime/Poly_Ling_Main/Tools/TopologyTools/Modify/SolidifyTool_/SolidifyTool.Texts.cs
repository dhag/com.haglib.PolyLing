...
namespace Poly_Ling.Tools
{
    public partial class SolidifyTool
    {
        private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
        {
            ...
            ["Help"] = new() { ["en"] = "Give thickness to the selected thin faces.\nTwo copies (front / flipped back) are offset by half the thickness and their boundary edges are bridged.", ["ja"] = "選択した薄い面群に厚みを付けます。\n表裏2枚のコピーを厚みの半分ずつ移動し、境界辺を側面でつなぎます。\n元の面はそのまま残ります。", ["hi"] = "えらんだうすいめんをあつくするよ\nもとのめんはのこるよ" },
            ...
            ["Done"] = new() { ["en"] = "Solidified {0} faces (boundary edges {1}, side faces {2})", ["ja"] = "{0} 面を厚み付けしました（境界辺 {1} / 側面 {2}）", ["hi"] = "{0}めんをあつくしたよ" },
            ["DoneNoBoundary"] = new() { ["en"] = "Solidified {0} faces (no boundary edge found)", ["ja"] = "{0} 面を厚み付けしました（境界辺なし）", ["hi"] = "{0}めんをあつくしたよ" },
        };
