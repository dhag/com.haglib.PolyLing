...
namespace Poly_Ling.OBJ
{
    ...
    public class ObjExportSettings
    {
        ...
        [Range(1, 9)]
        [PLParam(Description = "座標・UV・法線の小数点以下桁数", Min = 1, Max = 9)]
