...
namespace Poly_Ling.Data
{
    ...
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "直方体を作る。角丸と軸ごとの分割を指定できる。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Effects = PLCommandEffect.CreatesObject, Writes = PLWriteScope.Targets, Description = "球を作る。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "MCP用サンドボックスの円筒を作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Effects = PLCommandEffect.CreatesObject, Writes = PLWriteScope.Targets, Description = "円柱を作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "カプセルを作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "平面を作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "角錐を作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Effects = PLCommandEffect.CreatesObject, Writes = PLWriteScope.Targets, Description = "角丸の長円柱（スタジアム形）を作る。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "パイプ接続用小判型（手のひらのもと）。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.special", Writes = PLWriteScope.Targets, Description = "髪の房。房 M 個 × 筒 N 本 の独立したチューブを 1 つの描画オブジェクトに入れる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "多角形の歯を持つ歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.primitive", Writes = PLWriteScope.Targets, Description = "多角形の星形を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "インボリュート平歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "はすば歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "内歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "インボリュートのラック（直線歯）を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "はすばのラックを作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "すぐばかさ歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "まがりばかさ歯車を作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "円筒ウォームを作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "ウォームホイールを作る。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "プロペラ・ファンを作る。ハブ・翼・任意のダクトからなる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "ナットを作る。六角・四角・丸の外形と雌ねじを持つ。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "ネジ配置。配置元オブジェクトを円周上（PCD）または長方形の周上へ複製する。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "軸受ホルダを作る。ボスとフランジ、取付穴、締結部からなる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "軸受ユニットを作る。ハウジング・外輪・内輪と、任意で玉を持つ。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "自在継手を作る。単一カルダンとダブルカルダンを選べる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "モータ取付ブラケットを作る。丸クランプ・面板・L 形・U 形を選べる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "ロッドエンドを作る。雄ねじ・雌ねじ・ボールスタッドを選べる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "軸継手を作る。剛性スリーブ・クランプ・ジョー・オルダム・ベローズを選べる。")]
    ...
    [PLCommand(Category = "geometry.create.mechanical", Writes = PLWriteScope.Targets, Description = "台形ねじを作る。雄ねじ軸と、かみ合うナットを選べる。")]
    ...
    [PLCommand(Category = "geometry.create.special", Writes = PLWriteScope.Targets, Description = "平行歯面スプラインを作る。軸と、かみ合うナットを選べる。")]
    ...
    [PLCommand(Category = "geometry.create.special", Writes = PLWriteScope.Targets, Description = "リボンの蝶結びを作る。輪・端・結び目を別々に指定できる。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.special", Effects = PLCommandEffect.CreatesObject, Writes = PLWriteScope.Targets, Description = "回転体。プロファイル（断面の点列）は RevolutionParams.Profile が持つ。")]
    ...
    /// </summary>
    [PLCommand(Category = "geometry.create.special", Effects = PLCommandEffect.CreatesObject, Writes = PLWriteScope.Targets, Description = "2D 押し出し。ループ（輪郭の点列）は Profile2DParams.Loops が持つ。")]
    ...
    [PLCommand(Category = "geometry.create.special", Writes = PLWriteScope.Targets, Description = "文字列からメッシュを作る。フォントの輪郭を押し出す。")]
