...
namespace Poly_Ling.EditorBridge
{
    ...
    public class PolyLingPlayerBridge : IEditorBridge
    {
        ...
        // ================================================================
        // ダイアログ — Win32FileDialog（Runtime 共有実装）へ委譲
        //
        // P/Invoke 本体は Runtime/Poly_Ling_Main/Core/EditorBridge/Win32FileDialog.cs。
        // Editor 実装（PolyLingEditorBridgeImpl）と同じ実装を共有するため切り出した。
