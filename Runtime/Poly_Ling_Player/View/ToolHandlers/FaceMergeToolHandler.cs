...
namespace Poly_Ling.Player
{
    public class FaceMergeToolHandler : IPlayerToolHandler
    {
        ...
        private readonly FaceMergeTool  _tool = new FaceMergeTool();
        ...
        ///
        /// 【マウス／パネル経路と同じ実装を通す】
        ///   実処理は FaceMergeTool が正典。ここは対象の照合だけを行い、
        ...
        public bool ExecuteFromCommand(Poly_Ling.Data.FaceMergeCommand cmd, out string reason)
        {
            reason = null;
