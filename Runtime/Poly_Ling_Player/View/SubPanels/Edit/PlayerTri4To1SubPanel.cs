...
namespace Poly_Ling.Player
{
    ...
    {
        public Func<Tri4To1ToolHandler> GetH;
        ...
        private void UpdateStats()
        {
            ...
            if (!info.CanExecute)
            {
                if (_targetLabel != null)
                    _targetLabel.text = $"選択中: {h.SelectedFaceCount} 面  /  除外: {info.SkippedCount} 面";
            ...
            if (_targetLabel != null)
                _targetLabel.text = $"対象: {info.ObjectCount} オブジェクト / {info.TargetCount} 面"
