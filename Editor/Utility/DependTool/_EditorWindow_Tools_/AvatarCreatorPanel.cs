    ...
    public class AvatarCreatorPanel : EditorWindow
    {
        ...
        private void ExecuteCreate()
        {
            ...
            try
            {
                ...
                _lastCreatedAvatar = EditorAvatarCreator.BuildAndSaveAvatar(_rootObject, found, savePath);
        ...
        public static Avatar BuildAndSaveAvatar(
            ...
            string savePath)
            => EditorAvatarCreator.BuildAndSaveAvatar(rootObject, boneMapping, savePath);

        private static void ValidateHumanoidHierarchy(
            Dictionary<string, Transform> mapping,
            List<string> skipped)
            => EditorAvatarCreator.ValidateHumanoidHierarchy(mapping, skipped);

        private static void CreateFolderRecursive(string path)
            => EditorAvatarCreator.CreateFolderRecursive(path);
    }
}
