...
namespace Poly_Ling.PMX
{
    ...
    public class PMXImportPanel : Tools.IToolPanelBase
    {
        ...
        private static string T(string key) => L.GetFrom(PMXImportTexts.Texts, key);
        private static string T(string key, params object[] args) => L.GetFrom(PMXImportTexts.Texts, key, args);
