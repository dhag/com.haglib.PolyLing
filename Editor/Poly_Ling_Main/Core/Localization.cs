...
namespace Poly_Ling.Localization
{
    ...
    public static class L
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> _texts = new()
        {
            ...
            ["ShowBones"] = new() { ["en"] = "Bones", ["ja"] = "ボーンを表示" },
            ...
            ["ResetToOriginal"] = new() { ["en"] = "Reset to Original", ["ja"] = "もとの形状に戻す", ["hi"] = "さいしょにもどす" },
            ...
            ["LiveSyncTarget"] = new() { ["en"] = "Sync Target:", ["ja"] = "同期先:", ["hi"] = "どうきさき:" },
            ["LiveSyncAuto"] = new() { ["en"] = "Auto Sync", ["ja"] = "自動同期", ["hi"] = "じどうどうき" },
            ["LiveSyncApply"] = new() { ["en"] = "Apply", ["ja"] = "反映", ["hi"] = "はんえい" },
            ["LiveSyncNoTarget"] = new() { ["en"] = "LiveSync: Export to hierarchy first", ["ja"] = "LiveSync: 先にヒエラルキーに追加", ["hi"] = "LiveSync: さきについか" },
            ["ExportModel"] = new() { ["en"] = "Save...", ["ja"] = "保存...", ["hi"] = "ほぞん..." },
            ["ImportModel"] = new() { ["en"] = "Open...", ["ja"] = "開く...", ["hi"] = "ひらく..." },
            ["ExportModelCsv"] = new() { ["en"] = "Save (CSV)...", ["ja"] = "保存 (CSV)...", ["hi"] = "ほぞん (CSV)..." },
            ["ImportModelCsv"] = new() { ["en"] = "Open (CSV)...", ["ja"] = "開く (CSV)...", ["hi"] = "ひらく (CSV)..." },
            ["MergeModelCsv"] = new() { ["en"] = "Add from CSV Folder...", ["ja"] = "CSVフォルダから追加...", ["hi"] = "CSVふぉるだからついか..." },
            ...
            ["UseNameBasedSave"] = new() { ["en"] = "Name-Based Save", ["ja"] = "名前ベース保存", ["hi"] = "なまえべーすほぞん" },
