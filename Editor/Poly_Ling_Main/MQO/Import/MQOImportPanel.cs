...
namespace Poly_Ling.MQO
{
    ...
    public class MQOImportPanel : Tools.IToolPanelBase
    {
        ...
        private static string T(string key) => L.GetFrom(MQOImportTexts.Texts, key);
        private static string T(string key, params object[] args) => L.GetFrom(MQOImportTexts.Texts, key, args);
