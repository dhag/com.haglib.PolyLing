...
public partial class CubeMeshCreatorWindow : MeshCreatorWindowBase<CubeMeshCreatorWindow.CubeParams>
{
    // ================================================================
    // パラメータ構造体
    // ================================================================
    ...
    private MeshObject GenerateSimpleCubeMeshObject()
    {
        ...
        Vector3 pivot = new Vector3(
            _params.Pivot.x * Mathf.Max(_params.WidthTop, _params.WidthBottom),
            _params.Pivot.y * _params.Height,
            _params.Pivot.z * Mathf.Max(_params.DepthTop, _params.DepthBottom));

        float halfWT = _params.WidthTop * 0.5f;
        float halfWB = _params.WidthBottom * 0.5f;
        float halfDT = _params.DepthTop * 0.5f;
        float halfDB = _params.DepthBottom * 0.5f;

        AddQuadFace(md,
            new Vector3(halfWB, -halfH, halfDB) - pivot,
            new Vector3(halfWB, -halfH, -halfDB) - pivot,
            new Vector3(halfWT, halfH, -halfDT) - pivot,
            new Vector3(halfWT, halfH, halfDT) - pivot,
